<template>
    ...
    <div>
        <h1 class="font-medium leading-tight text-5xl mt-0 mb-2 text-blue-600">Crear Curso</h1>
                    ...
                    <div class="flex ">
                        <div class="mb-3 xl:w-96">
                            <select class="form-select appearance-none
                                ...
                                <option v-for="teacher of teachers" :key="teacher.id" :id="teacher.id" :value="teacher.id">{{teacher.full_name}} - {{teacher.profession}}</option>
                            </select>
                        </div>
                    </div>
                </div>
...
export default{
    ...
    methods:{
        async save(){
            console.log('------------------');
            console.log(this.grade.teacher_id);
            console.log('------------------');
